...
VALUES
    ...
    ('00000000-0000-0000-0000-000000000102', 'wallet:view', 'View wallet balance', now()),
    ('00000000-0000-0000-0000-000000000103', 'wallet:create', 'Create wallet transactions', now()),
    ('00000000-0000-0000-0000-000000000104', 'catalogue:create', 'Create catalogue listings', now()),
    ('00000000-0000-0000-0000-000000000105', 'catalogue:update', 'Update catalogue listings', now()),
    ('00000000-0000-0000-0000-000000000106', 'catalogue:delete', 'Delete catalogue listings', now());
...
VALUES
    ...
    ('00000000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000104', now()),
    ('00000000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000105', now()),
    ('00000000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000106', now());
