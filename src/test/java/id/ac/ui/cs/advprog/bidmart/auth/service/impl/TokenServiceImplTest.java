...
class TokenServiceImplTest {
    ...
    @Test
    void constructorRejectsShortJwtSecret() {
        AuthProperties properties = properties();
        properties.setJwtAccessSecret("too-short");

        assertThrows(IllegalArgumentException.class, () -> new TokenServiceImpl(properties));
    }

    @Test
    void parseAccessTokenRejectsMalformedToken() {
        assertThrows(InvalidAccessTokenException.class, () -> tokenService.parseAccessToken("not-a-jwt"));
    }
